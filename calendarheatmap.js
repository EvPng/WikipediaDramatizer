...
function calendarHeatmap() {
  ...
  var width = 1440; //d3.select(selector).style('width');
  var height = 150;
  var legendWidth = 50;
  var SQUARE_LENGTH = 15;
  var SQUARE_PADDING = 2;
  var MONTH_LABEL_PADDING = 24;
  ...
  chart.startDate = function (valueS,valueE) {
  ...
  function chart() {
    ...
    var dateRange = ((d3.time && d3.time.days) || d3.timeDays)(start, end); // generates an array of date objects within the specified range
    var monthRange = ((d3.time && d3.time.months) || d3.timeMonths)(moment(start).startOf('month').toDate(), end); // it ignores the first month if the 1st date is after the start of the month
    ...
    // width = dateRange.length * (SQUARE_LENGTH + SQUARE_PADDING) + 500
      ...
      if (chart.legendEnabled()) {
        ...
        legendGroup.selectAll('.calendar-heatmap-legend')
          ...
          .append('rect')
            ...
            .attr('width', SQUARE_LENGTH)
            .attr('height', SQUARE_LENGTH)
            .attr('x', function (d, i) { return 5 + (i + 2) * 15; })
        ...
        legendGroup.append('text')
          ...
          .attr('x', 5)
          .attr('y', height + SQUARE_LENGTH + SQUARE_PADDING * 5)
          .text(locale.Less);

        legendGroup.append('text')
          .attr('class', 'calendar-heatmap-legend-text calendar-heatmap-legend-text-more')
          .attr('x', 5 + SQUARE_PADDING * 3 + (colorRange.length + 2) * 15)
          .attr('y', height + SQUARE_LENGTH + SQUARE_PADDING * 5)
          .text(locale.More);
      }
